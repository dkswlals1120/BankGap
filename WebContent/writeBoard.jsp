	...
	<header class="mastheadWriteBoard">
		<section class="page-section">
			<div class="container text-center" id="formContent" style="width: 50%">
				...
				<form action="BoardServlet.do?command=writeBoard" method="post" onsubmit="return chkBoardType();" enctype="multipart/form-data">
				...
				<table>
					<tr>
						<td>
							<div style="margin-left: 13px; margin-top: 0; text-align: left;" >
					...
					<tr>
						<td>
							<div id="item">
								<textarea name="content" rows="14" cols="100" style="margin-left: 12px; resize:none"></textarea>
							</div>
