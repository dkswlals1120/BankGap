    ...
    <section class="page-section">
      <div class="container text-center" style="width: 50%;" id="formContent">
      		 <div class="tip-title" style="float:left"> 
      		 	<h1 id="login_logo" style="font-size:15pt">Tip!</h1>
      		 </div>
      		 <br>
      		 <br>
         	<table style="border-radius:10px">
         		...
         		<tr align="left">
         			...
         			<div><img src="<%=request.getContextPath() %>/board/${boarddto.refilename }" height="400pt" width="100%"></div>
         			</c:if>
         			${boarddto.content }
         			</td>
         		</tr>
         	...
         	<table>
		 	 ...
		 	 <form action="BoardServlet.do" method="get">
		 	 	...
		 	 	<input type="hidden" name="boardtype" value="T">
		 	  ...
		 	  <c:choose>
		 	   ...
		 	   <tr>
					...
					<span><input type="submit" value="댓글등록" disabled="disabled"/></span>
		 	  	</td>
		 	  	</tr>
		 	   </c:when>
		 	  <c:otherwise>
