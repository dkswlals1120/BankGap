    ...
    <section class="page-section">
      <div class="container text-center" style="width: 50%;" id="formContent">
      		 <div class="tip-title" style="float:left"> 
      		 	<h1 id="login_logo" style="font-size:15pt">Expert Evaluation!</h1>
      		 </div>
      		 <br>
      		 <br>
         	<table style="border-radius:10px">
         		<tr align="left">
         			<td colspan="3">
         			<b>${boarddto.writer}</b> 
         			<div style="font-size:10pt">${boarddto.regdate } 작성</div>
         		...
         		<tr align="left">
         			...
         			<td colspan="2">
         			<c:if test="${boarddto.refilename ne null }" >
         			<div><img src="/board/${boarddto.refilename }" height="400pt"></div>
         			</c:if>
         			<table class="table2">
             <thead>
              <tr>
            ...
            <c:choose>
        	 ...
        	 <div align="center" style="font-size: 15pt"><b>${boarddto.writer } 님의 지출내역을 피드백 해주세요</b></div>
         			</td>
         		</tr>
         	</table>
         	<br>
         	...
         	<table>
		 	 ...
		 	 <form action="BoardServlet.do" method="get">
		 	 	...
		 	 	<input type="hidden" name="boardtype" value="E">
