   ...
   <header class="masthead">
    <div class="container">
      <div class="intro-text">
        ...
        <div class="intro-heading text-uppercase" style="font-size: 72px; color: white;">Tip</div>
      </div>
    </div>
  </header>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12 text-center" data-aos="zoom-in">
        <h2 class="section-heading text-uppercase">Tip</h2>
        <h3 class="section-subheading text-muted">유저들의 꿀팁</h3>
      </div>
    </div>
      ...
      <c:choose>
			...
			<c:otherwise>
				<c:forEach var="tiplist" items="${selectlist }">
					<tr>
						<td>${tiplist.seq }</td> 
						<td>${tiplist.writer }</td>
						<td><a href="BoardServlet.do?command=tipdetail&seq=${tiplist.seq}">${tiplist.title }</a></td>
						<td>${tiplist.regdate }</td>
					</tr>
				</c:forEach>
			</c:otherwise>
		</c:choose>     
